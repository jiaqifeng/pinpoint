...
@TargetMethods({
    ...
    @TargetMethod(name = "prepare", paramTypes = { "com.datastax.driver.core.Statement" })
})
public class CassandraSessionPrepareInterceptor extends SpanEventSimpleAroundInterceptorForPlugin {

    public CassandraSessionPrepareInterceptor(TraceContext context, MethodDescriptor descriptor) {
