...
import com.navercorp.pinpoint.plugin.cassandra10.CassandraConstants;

/**
 * @author dawidmalina
 */
@TargetMethod(name = "connect", paramTypes = { "java.lang.String" })
public class CassandraClusterConnectInterceptor extends SpanEventSimpleAroundInterceptorForPlugin {

    private final boolean recordConnection;

    public CassandraClusterConnectInterceptor(TraceContext context, MethodDescriptor descriptor) {
