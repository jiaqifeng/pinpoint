...
public class KafkaValueDecoderInterceptor extends SpanSimpleAroundInterceptor {
    ...
    protected Trace createTrace(Object target, Object[] args) {
        if (args !=null && args[0] instanceof byte[]) {
            ...
            if (pos == -1) {
                System.out.println("KafkaValueDecoderInterceptor.createTrace(): no header, return trace=null");
                return null;
            }

            String[] headers = value.substring(0,pos).split("\\^");
            logger.error("KafkaValueDecoderInterceptor.createTrace(): get totla "+headers.length+" ids");
            ...
            if (transactionId == null) {
                logger.error("KafkaValueDecoderInterceptor.createTrace(): createTrace: transactionId = null");
            ...
            short flags = NumberUtils.parseShort(headers[5], (short) 0);
        ...
        logger.error("KafkaValueDecoderInterceptor.createTrace: args or args[0] is not what expected");
        return null;
    }
